...
### How it works
Exactly the same way as [WAUZ](https://github.com/mbodm/wauz). Instead of selecting the 2 folders in a GUI, just run _wauzcmd.exe_ and pass those 2 folders as command line arguments.
